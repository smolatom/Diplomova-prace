...
\input{vnitrek_kapitola3.tex}  % Popis existujících kompresních algoritmů
\input{vnitrek_kapitola4.tex}  % Přehled existujících kompresních algoritmů pro efektivní uchovávání dat ve formátech XML a JSON
\input{vnitrek_kapitola5.tex}  % Vlastní implementace vybraných kompresních algoritmů
\input{vnitrek_kapitola6.tex}  % Porovnání účinnosti komprese dat ve formátech XML a JSON
